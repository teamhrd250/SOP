...
#workspace{{height:calc(100vh - 58px);display:grid;grid-template-columns:205px minmax(0,1fr);overflow:hidden;background:#EAF0F5;position:relative}}
#stickyPane{{grid-column:1;width:205px;min-width:205px;max-width:205px;overflow:hidden;background:white;z-index:40;border-right:1px solid #B9C9D8;box-shadow:5px 0 12px rgba(16,42,65,.12)}}
...
#viewport{{grid-column:2;min-width:0;height:100%;overflow-x:auto;overflow-y:auto;background:#EAF0F5;position:relative;scrollbar-gutter:stable}}
#scrollSurface{{position:relative;min-height:100%;}}
...
setTimeout(()=>{{setZoom(1);document.getElementById('viewport').scrollTo({{left:0,top:0}});syncStickyY();}},100);
</script></body></html>
"""
    return html, height
