...
def build_swimlane_html(processes, presentation=False):
    ...
    for idx, p in enumerate(processes):
        ...
        # Special Legal + Finance parallel review after Contract / PO process (process 8).
            ...
            rows.append(f'<rect x="{group_left}" y="{contract_y-38}" width="{group_w}" height="132" rx="12" fill="#FBFDFF" stroke="#7AA8D8" stroke-width="1.2" stroke-dasharray="5 4"/>')
            ...
            merge_y = join_y + 18
            rows.append(f'<polygon points="{merge_x},{merge_y-18} {merge_x+26},{merge_y} {merge_x},{merge_y+18} {merge_x-26},{merge_y}" fill="#EFF8F1" stroke="#279647" stroke-width="1.4"/>')
...
.parallel-line{{fill:none;stroke:#2F80ED;stroke-width:1.35}} .parallel-return{{fill:none;stroke:#279647;stroke-width:1.35}} .parallel-card,.contract-review-card{{cursor:pointer}}
.parallelGroupTitle{{font-size:11px;font-weight:900;fill:#274C70}} .mergeText{{font-size:8px;font-weight:900;fill:#21883D}} .parallelDept{{font-size:9px;font-weight:900;fill:#60788F;letter-spacing:.04em}} .parallelTitle{{font-size:10px;font-weight:900;fill:#0B3152}} .parallelHint{{font-size:8px;font-weight:800;fill:#4B6680}}
