...
#viewport{{padding:14px;overflow:auto;height:calc(100vh - 74px);min-height:760px;background:#05070A;position:relative}}
...
<script>
const processes={p_json}; const departments={dep_json}; const parallelAuthority={parallel_json}; const contractReviewParallel={contract_review_json}; let zoom=1;
