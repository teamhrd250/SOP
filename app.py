...
#workspace{{height:calc(100vh - 58px);overflow:hidden;background:#EAF0F5;position:relative}}
#viewport{{width:100%;height:100%;overflow:auto;background:#EAF0F5;position:relative;scrollbar-gutter:stable both-edges}}
